...
class Bcrypt extends AbstractLock implements LockInterface
{
    ...
    public function setOptions(array $options = []): void
    {
        ...
        if (!\is_null($this->options['salt'])) {
            \trigger_error('The salt option has been deprecated as of PHP 7.0.0. It is now preferred to simply use the salt that is generated by default.', E_USER_DEPRECATED);
        } else {
